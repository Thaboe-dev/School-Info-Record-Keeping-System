...
?>
<h1 class="text-primary"><i class="fas fa-users"></i> All Students Owing<small class="text-warning"> Fees Records</small></h1>
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item" aria-current="page">
      <a href="FPDF\debtors_file.php">Download as PDF</a>
    </li>
  </ol>
</nav>
