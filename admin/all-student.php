      ...
      <tr>
        ...
        echo '<td>' . $i . '</td>
          ...
          <a class="btn btn-xs btn-warning" href="index.php?page=editstudent&id='.base64_encode($result['id']).'&photo='.base64_encode($result['photo']).'">
           ...
           &nbsp; <a class="btn btn-xs btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="index.php?page=transfers&id='.base64_encode($result['id']).'&photo='.base64_encode($result['photo']).'">
...
<script type="text/javascript">
  function confirmationDelete(anchor) {
    var conf = confirm('Are you sure want to transfer this record?');
    if (conf)
