...
if (isset($_POST['updatestudent'])) {
	...
	if (mysqli_query($db_con, $query)) {
		...
		header('Location: user_home.php?page=user-all-student&edit=success');
	} else {
		header('Location: user_home.php?page=user-all-student&edit=error');
	}
}
?>
...
<nav aria-label="breadcrumb">
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item" aria-current="page"><a href="user_home.php?page=user-all-student">All Student </a></li>
...
<div class="row">
	<div class="col-sm-6">
		<form enctype="multipart/form-data" method="POST" action="">
			...
			<div class="form-group">
				<label for="name">Parent Email Address</label>
				<input name="email" type="text" class="form-control" id="email" value="<?php echo $row['email']; ?>" required="">
			</div>
			<div class="form-group">
				<label for="enrollmentdate">Enrollment Date</label>
				<input name="enrollmentdate" type="text" class="form-control" id="enrollmentdate" value="<?php echo $row['Enrollment Date']; ?>" required="">
			</div>
			<div class="form-group">
