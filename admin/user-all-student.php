  ...
  <tbody>
    ...
    while ($result = mysqli_fetch_array($query)) { ?>
      <tr>
        ...
        <td>' . $result['Health Status'] . '</td>
          <td>
            <a class="btn btn-xs btn-warning" href="user_home.php?page=user-editstudent&id=' . base64_encode($result['id']) . '&photo=' . base64_encode($result['photo']) . '">
              <i class="fa fa-edit"></i></a>

             &nbsp; <a class="btn btn-xs btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="user_home.php?page=user-delete&id=' . base64_encode($result['id']) . '&photo=' . base64_encode($result['photo']) . '">
