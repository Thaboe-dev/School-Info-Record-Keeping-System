...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="navbar-collapse collapse justify-content-end" id="navbarSupportedContent">
      ...
      $haha = mysqli_query($db_con, "SELECT * FROM `admins` WHERE `username`='$showuser';");
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="list-group">
          ...
          <a href="index.php?page=register" class="list-group-item list-group-item-action"><i class="fa fa-user-plus"></i> Add User</a>
          <a href="index.php?page=fees" class="list-group-item list-group-item-action"><i class="fa fa-users"></i> Fees Records</a>
