...
if (isset($_POST['updatestudent'])) {
    ...
    if (mysqli_query($db_con, $query)) {
        ...
        header('Location: index.php?page=fees&edit=success');
    } else {
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page"><a href="FPDF\fees_record.php?id=<?php echo $id; ?>"> Print Statement</a></li>
    ...
    <div class="col-sm-6">
        <form enctype="multipart/form-data" method="POST" action="">
            ...
            <div class="form-group">
                ...
                <input name="receiptno" type="text" class="form-control" id="receiptno" value="<?php echo $row['ReceiptNo']; ?>" required="">
            </div>

            <div class="form-group text-center">
                <input name="updatestudent" value="Update Record" type="submit" class="btn btn-success">
            </div>
        </form>
    </div>
</div>