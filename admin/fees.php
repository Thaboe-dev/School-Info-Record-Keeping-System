...
<h1><a href="index.php"><i class="fas fa-tachometer-alt"></i>Fees</a> <small>Satistics Overview</small></h1>
        ...
        <div class="card text-white bg-primary mb-3">
            ...
            <div class="list-group-item-primary list-group-item list-group-item-action">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <a href="debtors.php"><i class="fa fa-arrow-right float-sm-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
<table class="table  table-striped table-hover table-bordered" id="data">
    ...
    <tbody>
        ...
        while ($result = mysqli_fetch_array($query)) { ?>
          ...
          <td>' . $result['status'] . '</td>
          <td>
            <a class="btn btn-xs btn-warning" href="index.php?page=editfees&id=' . base64_encode($result['id']) . '">
